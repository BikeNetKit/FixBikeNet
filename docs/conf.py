...
.. only:: html
    ...
    .. note::
        ...
        | Interactive online version: :raw-html:`<a href="https://mybinder.org/FixBikeNet/master?urlpath=lab/tree/docs/{{ docname }}"><img alt="Binder badge" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>`
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(fixbikenet.__file__))
